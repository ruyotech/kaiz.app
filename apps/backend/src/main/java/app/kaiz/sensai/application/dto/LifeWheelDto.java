...
public record LifeWheelDto(
  ...
  public record RateDimensionRequest(
      @NotBlank String dimensionId, @Min(0) @Max(10) double score, @Size(max = 500) String notes) {}

  /** Historical dimension scores. */
  public record DimensionHistory(String dimensionId, List<DimensionSnapshot> snapshots) {}

  /** Point-in-time dimension score. */
  public record DimensionSnapshot(String sprintId, double score, String periodLabel) {}

...
import app.kaiz.sensai.domain.CeremonyType;
...
public record SprintCeremonyDto(
  ...
  public record StartCeremonyRequest(
      @NotNull CeremonyType ceremonyType, @NotBlank String sprintId) {}
  ...
  public record CeremonySchedule(String sprintId, List<CeremonySlot> ceremonies) {}

  /** Single ceremony slot. */
  public record CeremonySlot(
      CeremonyType type, Instant scheduledAt, CeremonyStatus status, boolean isOverdue) {}
}

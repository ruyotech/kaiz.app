...
/**
 * Enhanced response DTO supporting clarification flows. Replaces CommandCenterAIResponse for the
 * new flow.
 */
public record SmartInputResponse(
  ...
  public record ClarificationFlowDTO(
    ...
    public record QuestionDTO(
      ...
      public record OptionDTO(String value, String label, String icon, String description) {}
    }

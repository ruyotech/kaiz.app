...
/**
 * Structured clarification question for gathering missing information. Designed for quick, focused
 * interactions - not long conversations.
 */
public record ClarificationQuestion(
  ...
  public record QuestionOption(String value, String label, String icon, String description) {
  ...
  public static ClarificationQuestion eisenhowerQuadrant() {
    return new ClarificationQuestion(
        ...
        List.of(
            ...
            QuestionOption.of(
                "q2", "Important, Not Urgent", "🟢", "Schedule it - growth & prevention"),
  ...
  public static ClarificationQuestion confirmChallengeSuggestion(
      String challengeName, int duration) {
    return new ClarificationQuestion(
        "confirm_challenge",
        String.format(
            "Would you like to start a %d-day \"%s\" challenge?", duration, challengeName),
        QuestionType.YES_NO,
        List.of(
  ...
  public static ClarificationQuestion textInput(String id, String question) {
    return new ClarificationQuestion(
        id, question, QuestionType.TEXT_INPUT, List.of(), id, true, null);
  }
  ...
  public record Option(String value, String label, String icon, String description) {

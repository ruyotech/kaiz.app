...
/**
 * Service for managing Command Center admin settings. Handles LLM providers, system prompts, test
 * attachments, and feature flags.
 */
@Service
...
public class AdminCommandCenterService {
  ...
  public TestAttachmentResponse createTestAttachment(
      CreateTestAttachmentRequest request, MultipartFile file) {

...
public class OnboardingController {
  ...
  public ResponseEntity<ApiResponse<OnboardingDto.OnboardingResponse>> completeOnboarding(
      @CurrentUser UUID userId, @Valid @RequestBody OnboardingDto.OnboardingRequest request) {
    OnboardingDto.OnboardingResponse response =
  ...
  public ResponseEntity<ApiResponse<OnboardingDto.CorporateCodeValidation>> validateCorporateCode(
    ...
    OnboardingDto.CorporateCodeValidation response =
        onboardingService.validateCorporateCode(request.code());
    return ResponseEntity.ok(ApiResponse.success(response));
  }
}

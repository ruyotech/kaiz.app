...
public class OnboardingDto {
  ...
  public record OnboardingRequest(
      ...
      @NotNull @Size(min = 1) List<String> selectedTaskTemplateIds,
  ...
  public record CreatedTask(
      String id, String title, int storyPoints, String sprintId, boolean isRecurring) {}

  public record CreatedEpic(String id, String title, String icon, int taskCount) {}

  public record CreatedEvent(String id, String personName, String dateType, String date) {}
  ...
  public record TaskTemplatesResponse(List<TaskTemplateCategoryDto> categories) {}

  /** Response containing epic templates */
  public record EpicTemplatesResponse(List<EpicTemplateDto> epics) {}

  /** Corporate code validation request */
  public record ValidateCorporateCodeRequest(@NotBlank String code) {}

  /** Corporate code validation response */
  public record CorporateCodeValidation(boolean valid, String companyName, String message) {}
}

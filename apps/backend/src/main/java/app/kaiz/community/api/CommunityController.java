package app.kaiz.community.api;

import app.kaiz.community.application.CommunityService;
...
public class CommunityController {
  ...
  @Operation(
      summary = "Get community home data",
      description = "Returns featured content, activity, and top contributors for the current user")
  ...
  public ResponseEntity<ApiResponse<CommunityMemberResponse>> updateMemberProfile(
    ...
    CommunityMemberResponse response = communityService.updateMemberProfile(memberId, request);
    return ResponseEntity.ok(ApiResponse.success(response));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> acceptAnswer(
      @PathVariable UUID questionId, @PathVariable UUID answerId, @RequestParam UUID memberId) {
  ...
  public ResponseEntity<ApiResponse<StoryCommentResponse>> addStoryComment(
    ...
    StoryCommentResponse response = communityService.addStoryComment(storyId, authorId, request);
    return ResponseEntity.ok(ApiResponse.success(response));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> rateTemplate(
      @PathVariable UUID templateId, @RequestParam UUID memberId, @RequestParam int rating) {
  ...
  public ResponseEntity<ApiResponse<PartnerRequestResponse>> sendPartnerRequest(
      @RequestParam UUID fromMemberId, @Valid @RequestBody SendPartnerRequestRequest request) {
    PartnerRequestResponse response = communityService.sendPartnerRequest(fromMemberId, request);
    return ResponseEntity.ok(ApiResponse.success(response));
  }
  ...
  public ResponseEntity<ApiResponse<List<LeaderboardEntryResponse>>> getLeaderboard(
    ...
    List<LeaderboardEntryResponse> response = communityService.getLeaderboard(timeframe, limit);
    return ResponseEntity.ok(ApiResponse.success(response));
  }

...
import { adminApi, CreateArticleRequest } from '@/lib/api';
import {
    ArrowLeft,
    Save,
    Image as ImageIcon,
...
export default function CreateArticlePage() {
    ...
    const handleTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData(prev => ({
            ...prev,
            title,
            slug: prev.slug || generateSlug(title), // Only auto-generate if slug is empty or we dictate it? Better to only do it if user hasn't manually edited slug maybe. For now simple.
        }));
    };
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="space-y-4 bg-slate-900/50 p-6 rounded-xl border border-white/10">
                        ...
                        <div>
                            ...
                            <div className="flex items-center bg-slate-800/50 border border-white/10 rounded-lg px-4">
                                ...
                                <input
                                    ...
                                    className="w-full py-3 bg-transparent text-white focus:outline-none text-sm font-mono"
                ...
                <div className="space-y-6">
                    <div className="bg-slate-900/50 p-5 rounded-xl border border-white/10 space-y-6 sticky top-24">
                        ...
                        <div>
                            ...
                            {/* Temporary URL input until upload is real */}
                            <input
                                type="text"

...
export default function RegisterPage() {
  ...
  return (
    <Card className="w-full max-w-md relative z-10 bg-slate-900/80 backdrop-blur border-white/10">
      <CardHeader className="text-center">
        <Link href="/" className="flex items-center justify-center gap-2 mb-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-purple-600 flex items-center justify-center font-bold text-2xl text-white">
            K
          </div>
        </Link>
        <CardTitle className="text-2xl text-white">Join the Movement</CardTitle>
        <CardDescription className="text-slate-400">
          Start running your life like a product team
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="outline" className="border-white/10 hover:bg-white/5" type="button">

...
export const sprintCeremonyKeys = {
  ...
  reviewData: (sprintId: string) => [...sprintCeremonyKeys.all, 'reviewData', sprintId] as const,
  retroData: (sprintId: string) => [...sprintCeremonyKeys.all, 'retroData', sprintId] as const,
  ...
  ceremoniesForSprint: (sprintId: string) => [...sprintCeremonyKeys.all, 'ceremonies', sprintId] as const,
...
export const essentiaKeys = {
  ...
  booksByLifeWheelArea: (areaId: string) => [...essentiaKeys.all, 'lifeWheel', areaId] as const,
  featured: () => [...essentiaKeys.all, 'featured'] as const,
